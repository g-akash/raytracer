...
class Light
{
  ...
  public:
     ...
     */
    virtual Ray getShadowRay(Vec3 const & position, bool & use_dist, double width, double height, double length, double diff, int pos) const = 0;
};
...
class AmbientLight : public Light
{
  public:
    ...
    Ray getShadowRay(Vec3 const & position, bool & use_dist, double width, double height, double length, double diff, int pos) const;
};
